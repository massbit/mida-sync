...
export interface NotifireIntervention {
    id: string
    latitude: number
    longitude: number
    radius: number
...
export const getInterventionsFromNotifire = async (): Promise<NotifireIntervention[]> => {
    return mockNotifireData
    // return axios
    //     .get(
    //         `https://notifire.vigilfuoco.it/notifire/rest/alerts?latitude=${MolinellaCoordinates.latitude}&longitude=${MolinellaCoordinates.longitude}&language=it`
    //     )
